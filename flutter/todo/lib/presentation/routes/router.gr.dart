...
class AppRouter extends _i5.RootStackRouter {
  ...
  List<_i5.RouteConfig> get routes => [
        ...
        _i5.RouteConfig(TodoDetailPageRoute.name, path: '/todo-detail-page')
      ];
}
...
class TodoDetailPageRoute extends _i5.PageRouteInfo<TodoDetailPageRouteArgs> {
  TodoDetailPageRoute({_i6.Key? key, required _i7.Todo? todo})
      : super(TodoDetailPageRoute.name,
            path: '/todo-detail-page',
            args: TodoDetailPageRouteArgs(key: key, todo: todo));

  static const String name = 'TodoDetailPageRoute';
}

class TodoDetailPageRouteArgs {
  const TodoDetailPageRouteArgs({this.key, required this.todo});
